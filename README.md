...
- 📡 **کاتالوگ پروکسی زنده**: اتصال مستقیم به [EDT-Pages/Proxy-List](https://github.com/EDT-Pages/Proxy-List) — هزاران پروکسی HTTP/HTTPS/SOCKS5 با پرچم، شهر و ASN؛ با یک کلیک هر کشور را به‌عنوان لوکیشن ذخیره کنید (کش ۱۰ دقیقه‌ای در KV)
